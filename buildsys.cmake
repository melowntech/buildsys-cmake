...
if(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  include(${BUILDSYS_ROOT}/macros/cmake-support.linux.cmake)
elseif(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
  include(${BUILDSYS_ROOT}/macros/cmake-support.darwin.cmake)
elseif(WIN32)
  include(${BUILDSYS_ROOT}/macros/cmake-support.windows.cmake)
else()
...
macro(enable_cpp11)
  if (${CMAKE_CXX_COMPILER_ID} MATCHES GNU)
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++0x -Wnon-virtual-dtor -Wno-unused-function -Wno-misleading-indentation")
